...
* Slidergezz.js
* Version: 1.3.8
* Author: GEZZ FASHION STYLE
*
* (c) 2010-2011 Devtrix. All rights reserved
**/

var Slidergezz = new function(){
	var Slidergezz = this;
	...
	function defineObject(t, o){
		...
		if(o){
			...
			}else o.name = 'Slidergezz-nameless-object-'+definedObjects[t].length;
			if(n >= 0) definedObjects[t][n] = o;
			else definedObjects[t].push(o);
		}
	}//defineObjects
	Slidergezz.easing = function(e){defineObject('easing', e);}
	Slidergezz.order = function(e){defineObject('order', e);}
	Slidergezz.effect = function(e){defineObject('effect', EffectObject(e));}
	...
	function EffectObject(a){
		...
		if(!a.name) a.name = 'Slidergezz-nameless-effect-'+_EffectObject++;
	...
	Slidergezz.slider = function(parameters){
		setOpacityInit();
...
Slidergezz.easing({name: 'none', method: function(x){return x;}});
Slidergezz.easing({name: 'swing', method: function(x){return -Math.cos(x*Math.PI)/2 + 0.5;}});
Slidergezz.easing({name: 'wave', method: function(t){return ((Math.cos((1-t)*3*Math.PI+2*Math.PI))*0.5+0.5+t)/2;}});
Slidergezz.easing({name: 'bounce', method: function(t){return 1 - Math.abs(Math.cos((1-t)*(2.5+t*t*3)*Math.PI+0.5*Math.PI)*(1-t));}});
/* predefined order functions */
Slidergezz.order({name: 'straight', method: function(e){
...
Slidergezz.order({name: 'swirl', method: function(e){
	var cols = e.cols, rows = e.rows, road = e.road, count = e.count;
	var a = [], i = 0, c = 0, r = 0, cl = cols - 1, rl = rows - 1, il = count - 1, cr;
...
Slidergezz.order({name: 'snake', method: function(e){
	var cols = e.cols, rows = e.rows, road = e.road, count = e.count;
	var a = [], i = 0, c = 0, r = 0, cl = cols - 1, rl = rows - 1, il = count - 1, cr;
	var courses, course = 0;
	switch(road){
...
Slidergezz.order({name: 'straight_stairs', method: function(e){
	var cols = e.cols, rows = e.rows, road = e.road, count = e.count;
	var a = [], i = 0, c = 0, r = 0, cl = cols - 1, rl = rows - 1, il = count - 1, cr;
	switch(road){
...
Slidergezz.order({name: 'square', method: function(effect){
...
Slidergezz.order({name: 'rectangle', method: function(effect){
...
Slidergezz.order({name: 'random', method: function(effect){
	var a = [], tmp = [], r, c, i;
...
/* predefined effects */
Slidergezz.effect({name: 'fade', fade: true, duration: 800});
Slidergezz.effect({name: 'move', left: true, move: true, duration: 800});
Slidergezz.effect({name: 'stairs', cols: 10, rows: 15, delay: 8, order: 'straight_stairs', road: 'BL', fade: true});
Slidergezz.effect({name: 'blinds', cols: 10, delay: 100, duration: 600, order: 'straight', right: true, zoom: true, fade: true});
Slidergezz.effect({name: 'rain', cols: 10, delay: 100, duration: 600, order: 'straight', top: true,right: true, zoom:true, fade: true});

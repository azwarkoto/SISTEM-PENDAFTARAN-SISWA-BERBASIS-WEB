...
<table border='0' cellpadding='3' cellspacing='1' width='700' style='font-family: "time news roman"; font-size: 12px; background: #ffffff;'>
    ...
    <!-- kop -->
    <tr>
        <td colspan='3' align='center'>LAPORAN DATA SISWA SMA BUDAYA</td></tr>
        </table>
        <table border='1' cellpadding='0' cellspacing='0' width='100%'>
                        ...
                        <?php
                        $tampil=mysql_query("SELECT * FROM calon_siswa WHERE
                        tgl_daftar BETWEEN  '$_POST[tglawal]' AND  '$_POST[tglakhir]' ORDER BY nisn ASC");
                        $no = 1;
                        ...
                        ?>
                            ...
                            <td align="center"><?php echo "$r[telepon]"?></td></tbody>
                            </tr>
                ...
                <tr>
                <td colspan='7'>
                	<i><b><font color="red">*</font>TTL</b>: Tempat Tanggal Lahir</i>

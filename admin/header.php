        ...
        <div class="container topnav">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                    <li>
                        <a href="admin.php"><i class="glyphicon glyphicon-home"></i> Beranda</a>
                    </li>
                    
                    <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">
                    <i class="glyphicon glyphicon-tasks"></i> Master Data</a>
                    <ul class="dropdown-menu">

                    <li><a href="datapendaftar.php">
                    <i class="glyphicon glyphicon-user"></i> Data Pendaftar</a></li>
    
                    <li><a href="datapembayaran.php">
                    <i class="glyphicon glyphicon-shopping-cart"></i> Data Konfirmasi Pembayaran</a></li>

                    <li><a href="datasiswa.php">
                    <i class="glyphicon glyphicon-user"></i> Data Siswa</a></li>

...
<table border='0' cellpadding='3' cellspacing='1' width='700' style='font-family: "time news roman"; font-size: 12px; background: #ffffff;'>
    ...
    <tr><td colspan='3'><?php include 'kop.php' ?></td></tr>
        <tr><td colspan="3" align="center"><button class="btn btn-secondary" onclick="window.open('printsiswa.php?print=ya&nisn=<?php echo $b; ?>','popupwindow','scrollbars=yes, width=750,height=600');"><i class="glyphicon glyphicon-print"></i> Cetak</button></td></tr>
           <tr>
    <tr>

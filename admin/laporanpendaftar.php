...
<div class="container">
<center><h3>&nbsp;</h3>
  <h3><b>Laporan Data Pendaftar</b></h3>
</center>
<p>&nbsp;  </p>
    ...
    ?>
    <form action="laporanpendaftar.php" method="post" name="postform">
...
<?php
      ...
      <script language="JavaScript" required>
        ...
        document.location='laporandatapendaftar.php';
      </script>
      <?php
      }else{
      ...
      <?php
      $query=mysql_query("SELECT * FROM pendaftaran WHERE tgl_daftar BETWEEN '$tanggal_awal' AND '$tanggal_akhir'");
      $no=1;
      }
    ?>
    ...
    <form role="form" action="cetakpendaftar.php" method="POST" target="_blank">

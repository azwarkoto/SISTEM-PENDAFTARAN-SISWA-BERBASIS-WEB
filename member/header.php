        ...
        <div class="container topnav">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <i class="glyphicon glyphicon-user"></i> Member</a>
                    <ul class="dropdown-menu">

                    <li><a href="pembayaran.php">
                    <i class="glyphicon glyphicon-shopping-cart"></i> Pembayaran</a></li>
                              
                  </ul>
                  </li>
                    <li>
                        <a href="panduan.php"><i class="glyphicon glyphicon-list-alt"></i> Panduan PSB</a>
                    </li>
                    <li>
                        <a href="profil.php"><i class="glyphicon glyphicon-home"></i> Profil Sekolah</a>
                    </li>
                    <li>
